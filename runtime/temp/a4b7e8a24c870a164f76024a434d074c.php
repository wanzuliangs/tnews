                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="model_id">
                                            <option value="1" <?php if($catinfo == 1): ?>selected<?php endif; ?>>文章模型</option>
                                            <option value="2" <?php if($catinfo == 2): ?>selected<?php endif; ?>>电影模型</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="pid">
                                            ...
                                            <option value="<?php echo $cat['id']; ?>" <?php if($cat['id'] == $catinfo['pid']): ?>selected<?php endif; ?>><?php echo str_repeat('-',$cat['lev']*8) ?><?php echo $cat['cate_name']; ?></option>
